...
import { snailCallHandler, snailRegisterHandler, comicCallHandler, schemaCallHandler, readRegisterHandler, readCallHandler, lofterCallHandler, lofterSupport } from 'nejsbridge';
import objectAssign from 'object-assign';
import { compareVersion } from 'nw-toolkits/es/version-compare'; // import {lofterShareConfig, lofetrShare} from './appShareApi';
...
var shareData;
var callback;
export var setOrUpdate = function setOrUpdate(pshareData, callback_) {
...
export var share = function share(data, callback_) {
  ...
  if (isYueduApp()) {
    readRegisterHandler('shareComplete', callback);
    var yueduData = objectAssign({}, shareDataLocal, {
      activity: shareDataLocal.activityId,
