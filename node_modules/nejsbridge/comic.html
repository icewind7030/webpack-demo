...
<body>
    ...
    <script src="https://easyreadfs.nosdn.127.net/web/trunk/1511750707379/bridge.comic.iife.js"></script>
...
var reset = Array.prototype.slice.call(arguments)
        ...
        $('#share').on('click', function() {
            callHandler('share', {
                title: '分享测试',
                description: '分享描述',
                picurl: 'https://easyreadfs.nosdn.127.net/web/trunk/1502854027060/xxxxx2017-02-04xxx9.34.51.png?imageView&thumbnail=200y200',
        ...
        $('#savePictureAndShare').on('click', function() {
            callHandler('savePictureAndShare', {
                text: 'hello 李梅',
                picurl: 'https://easyreadfs.nosdn.127.net/web/trunk/1511851706984/xiazai_03.png',
        ...
        $('#savePictureAndShare2').on('click', function() {
            callHandler('savePictureAndShare', {
                text: 'hello 李梅',
                picurl: 'https://easyreadfs.nosdn.127.net/pic/2016/05/09/41955a58387d41de926dd98f20ba5dca.png?imageView'
            }, function(resp) {
               if (resp.code === 0) {
                   alert('保存成功');
               } else {
